        ...
        foreach ($santri as $s) {
            ...
            $data['ext'] =
                [
                    ...
                    'acc' => $this->santriModel->where('status_santri <> ', 'Suspend')->where('acc', true)->countAllResults() + $this->absensiModel->where('acc', true)->countAllResults() + $this->tunjanganModel->where('acc', true)->countAllResults() + $this->potonganModel->where('acc', true)->countAllResults(),
